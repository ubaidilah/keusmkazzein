...
class Auth extends CI_Controller
{
    ...
    if( $this->form_validation->run() == false){
      ...
      $this->load->view('templates/auth_footer');
        ...
        $data = [
          ...
          ($this->input->post('password1'),PASSWORD_DEFAULT),
          'role_id' => 2,
          'is_active' => 0,
          'date_created' => time()
        ];
        ...
        $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">
          Congratulation! your account has been created. <br>Please activate your account check your Email ! 
        </div>');
        redirect('auth');
    }
  }
  ...
  private function _sendEmail($token, $type)
  {
      $config = [
        ...
        'smtp_port' => 465,
        'smtp_user' => 'belajarapps2020@gmail.com',
        'smtp_pass' => 'ubainida',
        'mailtype' => 'html',
        'charset' => 'utf-8',
        'newline' => "\r\n"
      ...
      $this->email->from('belajarapps2020@gmail.com', 'No Replay');
      ...
      if ($type == 'verify') {
        ...
        <a href="'. base_url() . 'auth/resetpassword?email=' . $this->input->post('email') . '&token=' . $token . '">Resetpassword</a>');
      }
      if ($this->email->send()){
        return true;
      }else {
