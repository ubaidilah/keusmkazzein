  ...
  <div class="row">
    <div class="col-lg">
      ...
      <?php endif; ?>
        ...
        <div class="card-body">
          <form action="<?= site_url('jajan/save_jajan')?>" method="post">
            ...
            <div class="form-group row">
              <div class="col-sm-6 mb-3 mb-sm-0" >
              <label for="kredit">Uang Yang Diambil</label>
            ...
            <?php }else { ?>
              ...
              <?php } ?>
              <input type="hidden" class="form-control" id="tipe" value="<?=$detail['tipe']?>"  name="tipe" >
              <input type="hidden" class="form-control" id="jenis" value="<?=$detail['jenis']?>" name="jenis" >
            </div>
            <div class="col-md-12 bg-light text-right">
              <a href="<?= site_url('jajan/t_jajan')?>" type="submit" class="btn btn-warning right-block" >Batal</a>
