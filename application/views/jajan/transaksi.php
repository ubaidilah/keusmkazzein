    ...
    <div class="col-lg">
      ...
      <?php endif; ?>
              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body" onclick="toggler('ambil');">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="h5 mb-0 font-weight-bold text-gray-800">AMBIL UANG JAJAN</div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body" onclick="toggler('tambah');">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="h5 mb-0 font-weight-bold text-gray-800">SIMPAN UANG JAJAN</div>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                    </div>
        ...
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary">Pengambilan Uang Jajan</h6>
        </div>
        <div class="card-body">
          <form action="<?= site_url('jajan/cekout')?>" method="post">
            ...
            <div class="form-group">
              ...
              <input type="hidden" class="form-control" id="tipe" value="2" placeholder="Jumlah Uang yang diambil" name="tipe" >
      ...
      <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Simpan Uang Jajan</h6>
      </div>
      <div class="card-body">
        <form action="<?= site_url('jajan/cekout')?>" method="post">
          <div class="form-group row">
            <div class="col-sm-6 mb-3 mb-sm-0" >
            <label for="santri">Nama Santri</label>
            <select name="santri" id="santri" class="form-control select3">
              <option value="">Cari Santri</option>
              <?php foreach ($santri as $s) : ?>
                <option value="<?= $s['id'];?>"><?= $s['nama_santri'];?></option>
              <?php endforeach; ?>
          ...
          <div class="col-sm-6">
            <label for="tgl">Tanggal</label>
            <span class="fas fa-calendar-alt"></span>
            <input type="text" class="form-control" autocomplete="off" value="<?= date('Y-m-d'); ?>" id="datepickerT" placeholder="Tanggal Simpan Uang" name="tgl" >
          </div>
        </div>
          <div class="form-group">
            <label for="kredit">Jumlah Uang</label>
            <input type="number" class="form-control" id="kredit" placeholder="Jumlah Uang yang Simpan" name="kredit" >
            <input type="hidden" class="form-control" id="tipe" value="2" placeholder="Jumlah Uang yang diambil" name="tipe" >
